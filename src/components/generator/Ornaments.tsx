export function StarOrnament({ size = 40, color = '#b8975a' }: { size?: number; color?: string }) {
  return (
...
export function GeometricBorder() {
  return (
    <svg width="100%" height="6" viewBox="0 0 400 6" preserveAspectRatio="none" aria-hidden="true">
